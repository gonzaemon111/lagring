  ...
  describe 'GET index /api/shoppings' do
    ...
    context '正常系 200' do
      ...
      it 'Response OK' do
        ...
        expect(response.parsed_body['shoppings'][0]['started_at']).to eq(I18n.l(user.shoppings.first.started_at, locale: :ja))
        expect(response.parsed_body['shoppings'][0]['finished_at']).to eq(I18n.l(user.shoppings.first.finished_at, locale: :ja))
        expect(response.parsed_body['shoppings'][0]['repeat_frequency']).to eq(user.shoppings.first.repeat_frequency)
  ...
  describe 'GET show /api/shoppings/1' do
    ...
    context '正常系 200' do
      it 'Response OK' do
        ...
        expect(response.parsed_body['started_at']).to eq(I18n.l(user.shoppings.first.started_at))
        expect(response.parsed_body['finished_at']).to eq(I18n.l(user.shoppings.first.finished_at))
        expect(response.parsed_body['repeat_frequency']).to eq(user.shoppings.first.repeat_frequency)
